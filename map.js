var radiusInput = window.radiusInput || 2.5;
var counter = 0;
var trigger = false;
       var markers = [
    ...
    ["my House, Austin", 30.278904,-97.751414],
  ...
  $(document).on("click", '#add-userSchedule', function() {
     // var markers = [];
    console.log(markers);
    infoWindowContent = [];
          ...
          $.ajax({
            ...
            counter++
              ...
              for(var i = 0; i< data.results.length; i++)
              {
                ...
                infoWindowContent.push('<div class="info_content"> <h3>' + counter +  '</h3> </div>');
                // console.log(trigger);
              }trigger = true;
